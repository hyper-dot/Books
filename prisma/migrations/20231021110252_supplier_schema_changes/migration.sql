/*
  ...
  - You are about to alter the column `vat_no` on the `Suppliers` table. The data in that column could be lost. The data in that column will be cast from `String` to `Int`.
